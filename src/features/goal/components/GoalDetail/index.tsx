  ...
  return (
    <section className="flex flex-col gap-8 lg:flex-row">
      <div className="flex min-w-0 flex-1 flex-col gap-[10px]">
        <PageSubTitle
          ...
          actions={
            <div className="flex gap-2">
              <Button
                variant="cancel"
                className="rounded-full bg-gray-100 p-[10px] md:px-[14.5px] md:px-[18px] md:py-[10px] lg:py-[10px] dark:bg-gray-700"
              >
        ...
        <section className="dark:bg-gray-750 h-144 w-160 rounded-2xl bg-white px-7 py-8">
